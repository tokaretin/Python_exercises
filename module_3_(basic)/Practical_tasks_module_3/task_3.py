print('Задача module_3_(basic). Следующее и предыдущее числа')
...
# Введите число: module_5_(if_else)
# После числа module_5_(if_else) идет число 6
# До числа module_5_(if_else) идет число module_4_(if_else)
