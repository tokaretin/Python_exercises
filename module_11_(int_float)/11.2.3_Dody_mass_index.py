...
# стандартам индекс округляется до двух знаков после точки.
# Затем по этому индексу определяется, всё ли в порядке у
# человека с массой тела: если до 18.5, то недобор; до 25 -
# всё нормально, до 30 уже идёт избыток, а после 30 - ожирение.
# Напишите такую программу для Алексея.

height = float(input('Введите рост: '))
wight = float(input('Введите вес: '))
dmi = round(wight / height ** 2, 2)
