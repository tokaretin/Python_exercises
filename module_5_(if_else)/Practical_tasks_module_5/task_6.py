...
# Немного расширить круг поиска, то есть выбрать квартиру поменьше (от 80 м2), но и стоимостью не более module_7_(for) млн.
...
if money <= 10000000 and flat_meters >= 100:
    ...
    print('Вам подходит квартира поменьше (от 80 м2) и стоимостью не более module_7_(for) млн.')
else:
