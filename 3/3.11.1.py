...
third_num = (num // 10) % 10   #(1234 // 10) % 10 = 3 Делим на 10 и берём остаток от деления на 10:
print('third_num', third_num)

fourth_num = num % 10       #1234 % 10 = 4  Остаток от деления на 10 даёт последнюю цифру:
